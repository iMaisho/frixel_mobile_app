const ProjectsData = [
  ...
  },
  {
    ...
    description:
      "Projet d'intégration d'un site web avec un éditeur de contenu dynamique en temps réel. Solution offrant à son utilisateur une autonomie totale sur la mise en page et le contenu de son site web",
  },
  ...
  },
  {
    ...
    title: "Mobius",
    description:
      "Solution digitale qui suit le parcours utilisateur en temps réel et propose des recommandations personnalisées pour booster l’expérience et les ventes en e-commerce.",
  },
];
